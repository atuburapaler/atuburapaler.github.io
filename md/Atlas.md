![](https://cdn2.steamgriddb.com/hero/0eca12f9569ffde04e01e318ef40cd43.png)
!!! note Hello, friend.
...
Code|Meaning
-|-
Odin|This is the codename for Modern Warfare (2019)
Zeus|This is the codename for Black Ops: Cold War
Fore|This is the codename for Vanguard
Cortez|This is the codename for Modern Warfare II
Jupiter|This is the codename for Modern Warfare III
Warzone|This is the codename for Blackout
...
- **IW8** is named after **Infinity Ward's eight** title, **Modern Warfare**. **Vanguard** uses a really really similar engine with some mods, it's called **S4** because it's **Sledgehammer's fourth**.
...
![](../images/ui/Placeholder.png){50%:50%}

Name|Picture|Game|ID
-|-|-|-
Alcatraz|![](https://static.wikia.nocookie.net/callofduty/images/4/4a/Alcatraz_MenuScreen_BO4.jpg){1000px:500px}|![](../images/ui/BO4-icon.png){32px:32px}|`wz_escape`
Rebirth Island|![](../images/iw8/Rebirth.gif){1000px:500px}|![](../images/ui/WZ-icon.png){32px:32px}|`mp_escape2`,`mp_escape3`&`mp_escape4`
Rebirth Island|![](https://static.wikia.nocookie.net/callofduty/images/0/01/RebirthIsland_LoadingScreen_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_jup_escape5`
Rebirth Island "Hellspawn"|![](https://static.wikia.nocookie.net/callofduty/images/a/a7/Hellspawn_LoadingScreen_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_jup_escape5_hell`
Fortune's Keep|![](https://static.wikia.nocookie.net/callofduty/images/b/bc/FortunesKeep_LoadingScreen_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_jup_sm_island_2`
Al Mazrah|![](https://static.wikia.nocookie.net/callofduty/images/9/99/AlMazrah_LoadingScreen_Season5_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_saba2`
Ashika Island|![](https://static.wikia.nocookie.net/callofduty/images/8/84/AshikaIsland_LoadingScreen_Resurgence_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_sealion`
Vondel|![](https://static.wikia.nocookie.net/callofduty/images/f/f5/Vondel_LoadingScreen_WZ2.png){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_jup_delta`
Urzikstan|![](../images/iw9/Urzikstan.gif){1000px:500px}|![](../images/ui/WZ2-icon.png){32px:32px}|`mp_jup_bigmap_wz2`&`mp_jup_bigmap`
